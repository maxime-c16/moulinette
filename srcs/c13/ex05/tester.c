...
/*   Updated: 2024/06/30 18:20:34 by mcauchy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("Applying btree_search_item [RRight]:\n");
	printf("%s\n", (char *)btree_search_item(root, "RRight", &cmp));
	printf("Applying btree_search_item [LRight]:\n");
	printf("%s\n", (char *)btree_search_item(root, "LRLeft", &cmp));
	printf("Applying btree_search_item [(null)]:\n");
	printf("%s\n", (char *)btree_search_item(root, "", &cmp));
